...
using UnityEditor.IgaworksCommerceEditor;
using UnityEditor.XCodeEditor;

namespace UnityEditor.IgaworksCommerceEditor
{
	public static class XCodePostProcess
	{
		...
		public static void OnPostProcessBuild(BuildTarget target, string path)
		{
			...
			if (target == BuildTarget.iOS)
			{
				...
				string projModPath = System.IO.Path.Combine(Application.dataPath, "IgaworksCommerce/Editor/iOS");
